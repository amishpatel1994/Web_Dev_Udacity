...
"Group"===a.group_ref.ref&&e(a.group_ref.key)});a.ready=!0})}]);angular.module("overview").directive("nanodegreeEnrollmentActions",["cacheVersion","currentUser","groups","$location","dateTime","$window","adrollTracker","gaqHelper","cookieJar","googleTagManager",function(a,d,b,c,e,f,g,h,i,j){return{restrict:"A",scope:{enrollmentActions:"="},templateUrl:"/templates/overview/nanodegree_enrollment_actions.html?"+a,controller:"enrollmentActionsHelper",link:function(a){var b=function(a){return{nd001:{start:"Jan. 7 at noon Eastern Time",end:"Jan. 12 at 11:59 pm Eastern Time"},
nd002:{start:"Jan. 7 at noon Eastern Time",end:"Jan. 12 at 11:59 pm Eastern Time"},nd003:{start:"Mar. 4 at noon Eastern Time",end:"Mar. 9 at 11:59 pm Eastern Time"},nd004:{start:"Feb. 4 at noon Eastern Time",end:"Feb. 9 at 11:59 pm Eastern Time"}}[a]||{}};a.getNanodegreeButtonInfo=function(){return a.isAccessible&&(a.isPaidEnrolled||a.isPaidGraduated)?{variant:"nanodegree is live, student is enrolled or graduated",text:"Continue nanodegree",action:a._goToClass}:a.isPaidEnrollable?a.isClassFull?a.isPaidWaitlisted?
